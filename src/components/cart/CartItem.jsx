        ...
        <div className="flex items-center gap-5">
          ...
          >
            <img
              src={img}
              alt="img/cart/item"
              className="w-24 h-auto object-fill lg:w-28"
            />
          ...
          <div className="grid items-center gap-4 ">
            <div className="grid items-center leading-none">
              ...
              <p className="text-sm text-slate-900 lg:text-sm">{text}</p>
            </div>
            <div className="flex items-center justify-around w-full">
              ...
              >
                <MinusIcon className="w-5 h-5 text-white lg:w-4 lg:h-4 stroke-[2]" />
              </button>
              <button
                type="button"
                className="bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90"
              >
                <div className="text-white text-xs font-medium lg:text-xs w-7 h-6 lg:h-5 lg:w-6 flex items-center justify-center">
                  {cartQuantity}
                </div>
              </button>
              <button
